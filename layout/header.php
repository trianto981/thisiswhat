...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?php echo $url.'assets/img/logo2.jpg'; ?>">
  ...
  <body>
    ...
    <!-- Fixed navbar -->
    <nav class="navbar navbar-default navbar-fixed-top navbar-yellow bg-warning">
      <div class="container" style="background:#FFBF00;">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Web Pemesanan Mollys coffe X Eight food</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse"> 
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo $url ?>">Home</a></li>
            <li><a href="<?php echo $url ?>menu.php">Menu</a></li> 
            <li><a href="<?php echo $url ?>kontak.php">Kritik dan Saran</a></li> 
        ...
        <!-- Wrapper for Slides -->
          <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('assets/img/tampil2.jpg');"></div>
                <div class="carousel-caption">
                </div>
            </div>
            <div class="item">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill" style="background-image:url('assets/img/tampil5.jpg');"></div>
                <div class="carousel-caption">
                </div>
            </div> 
            <div class="item">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill" style="background-image:url('assets/img/tampil3.jpg');"></div>
            </div> 
            <div class="item">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill" style="background-image:url('assets/img/tampil4.jpg');"></div>
            </div> 
        </div>
   ...
   <?php } ?>
	...
	<div class="row">
		<div class="col-md-3">
			<div style="background:#FFBF00; width:100%; height:auto; padding-top:3px;padding-bottom:3px; padding-left:10px;">
			<h4>Kategori Menu</h4>
			</div>
			<ul class="kategori">
				<?php 
			...
			<div style="background:#FFBF00; width:100%; height:auto; padding-top:3px;padding-bottom:3px; padding-left:10px; 	margin-bottom:15px;">
			...
			<div class="row col-md-12">
        <hr>
        <a href="https://www.instagram.com/eight.food/">
        <img src="<?php echo $url.'assets/img/logo1.jpg'; ?>" width="100%"></a><br><br>
        <a href="https://www.instagram.com/mollys.coffee/">
				<img src="<?php echo $url.'assets/img/logo2.jpg'; ?>" href="" width="100%"></a><br><br>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3334.388892804314!2d106.91400823312873!3d-6.357922355196944!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6993bfedcc5185%3A0x3d0e4c70c6869065!2sTPU%20Pondok%20Ranggon!5e0!3m2!1sen!2sid!4v1627389655615!5m2!1sen!2sid" width="100%" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
			</div>
		</div>