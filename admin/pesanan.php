<?php 
	...
	if(!empty($_GET['act']) && $_GET['act'] == 'edit'){
		if(!empty($_POST)){
			...
			$q = mysql_query("update pesanan SET nama='$nama',tanggal_pesan='$tanggal_pesan',user_id='$user_id',alamat='$alamat',telephone='$telephone' where id=$_GET[id]") or die(mysql_error());
			if($q){ alert("Success"); redir("pesanan.php"); }
		}
	}
