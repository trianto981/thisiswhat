...
?> 
	...
	<div class="container">
		...
		<a class="btn btn-sm btn-warning" href="kategori_produk.php?act=create">Tambah Data</a>
		<hr>
		<?php
			if(!empty($_GET)){
				if($_GET['act'] == 'create'){
		...
		<?php while($data=mysql_fetch_object($q)){ ?> 
				<tr> 
					...
					<td>
						<a class="btn btn-sm btn-info" href="kategori_produk.php?act=edit&&id=<?php echo $data->id ?>">Edit</a>
